...
enemyDead = load_enemy_frames(['enemy/enemyDead/sprite-1-1.png','enemy/enemyDead/sprite-1-2.png','enemy/enemyDead/sprite-2-1.png'])
...
while running:
    ...
    enemy_frames = {"idle":enemyIdle,"hurt":enemyHurt,"run":enemyRun,"dead":enemyDead}[enemy_state]
    if enemy_state == "dead":
        enemy_frame_index += 0.05
    else:
